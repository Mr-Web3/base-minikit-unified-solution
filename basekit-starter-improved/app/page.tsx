      ...
      <div className="w-full mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            ...
            Farcaster integration. Connect your wallet and explore the features,
            then customize for your own project.
          </p>
          ...
          <div className="bg-gray-900/30 border border-gray-600 rounded-lg p-8 max-w-3xl mx-auto mb-8">
            ...
            <div className="text-left space-y-4 text-gray-300">
              ...
              <div className="flex items-start gap-3">
                ...
                <p>Your profile information will appear above when connected</p>
              </div>
              <div className="flex items-start gap-3">
            ...
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <button
                    onClick={() => openUrl("https://portal.cdp.coinbase.com/")}
                    className="w-full text-left p-3 bg-gray-800/50 hover:bg-gray-700/50 border border-gray-600 rounded-lg transition-colors flex items-start gap-3"
                  >
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-white">Sub Accounts</div>
                      <div className="text-sm text-gray-400">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-white">Base Channel</div>
                      <div className="text-sm text-gray-400">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-white">Base GitHub</div>
                      <div className="text-sm text-gray-400">
